...
// For example:
//
//   /discoverelectronics/browse/_/N-4294967107?Ntt=canon&format=xml
//
//     CONTEXT_PATH = /discoverelectronics
//     SERVLET_PATH = /servlet
//     PATH_INFO = browse/_/N-4294967107
...
%><a href="<c:url value="${dataViewUrl}" />" class="dataview"><c:out value="${fmt}"/></a>
